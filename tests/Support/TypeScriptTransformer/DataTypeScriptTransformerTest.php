...
class DataTypeScriptTransformerTest extends TestCase
{
    ...
    public function it_can_covert_a_data_object_to_typescript()
    {
        ...
        $data = new class (null, Undefined::make(), 42, true, 'Hello world', 3.14, ['the', 'meaning', 'of', 'life'], Lazy::create(fn () => 'Lazy'), SimpleData::from('Simple data'), SimpleData::collection([]), ) extends Data {
